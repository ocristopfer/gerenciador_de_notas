        ...
        <div id="app">
            ...
            <main role="main" class="container">
                ...
                <div class="starter-template">
                    ...
                    <div id="listaNotas">
                        <div id="listaAlunos" v-if="!verNotas">
                            <div style="float:left" class="mb-3">
                                <button class="btn btn-primary btn-sm"  v-on:click="novoAluno()" >Novo Aluno</button>
                            </div>
                            <table id="tbAlunos" class="table">
                                <thead>
                                    <tr>
                                        <td>Matricula</td>
                        ...
                        <div id="notasAluno" v-if="verNotas">
                            <!--div class="m-3">
                            ...
                            <div style="float:left" class="mb-3">
                                <button class="btn btn-primary btn-sm"  v-on:click="verNota()" >Voltar</button>
